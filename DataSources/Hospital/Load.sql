...
DECLARE @Clinic_Tables TABLE (ID INT IDENTITY, TableName NVARCHAR(100));
DECLARE @ICU_Tables TABLE (ID INT IDENTITY, TableName NVARCHAR(100));

INSERT INTO @Clinic_Tables (TableName) VALUES
('ADMISSIONS'), ('CALLOUT'), ('DIAGNOSES_ICD'), 
('D_ICD_DIAGNOSES'), ('PATIENTS'), ('SERVICES'), ('TRANSFERS');

INSERT INTO @ICU_Tables (TableName) VALUES
('CAREGIVERS'), ('D_ITEMS'), ('ICU_STAYS'),
('INPUT_EVENTS_CV'), ('INPUT_EVENTS_MV'),
